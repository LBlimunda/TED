...
\begin{figure}[h]
    ...
    \fbox{\parbox[c][5cm][c]{0.7\textwidth}{fig_variance.png}{\centering Variance $\sigma(Q_n)$ vs $n$}}
...
\begin{figure}[h]
    ...
    \fbox{\parbox[c][5cm][c]{0.7\textwidth}{fig_simulations.png}{\centering Convergence of $Q_n$ for Uniform, Bimodal, Skewed}}
